...
<head>
    ...
    <link rel="stylesheet" href="css/indexAlter.css">
    ...
    <div class="login-wrapper">
        ...
        <div class="form-wrapper">
            ...
            <div class="code" style="display: inline-block">
                ...
                <img src="http://localhost:8080/kaptcha.jpg" style="width: 45%; height: 7%; float: right;vertical-align:middle" id="CodeImg"
                     onclick="changeImage()">
            </div>
